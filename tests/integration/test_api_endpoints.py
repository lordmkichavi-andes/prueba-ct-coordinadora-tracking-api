...
class TestCheckpointAPI:
    ...
    def test_register_checkpoint_success(
        self, client, auth_headers, sample_tracking_id, sample_checkpoint_data
    ):
        ...
        response = client.post(
            "/api/v1/checkpoints", data=json.dumps(payload), headers=auth_headers
        )
    ...
    def test_register_checkpoint_missing_api_key(
        self, client, sample_tracking_id, sample_checkpoint_data
    ):
    ...
    def test_register_checkpoint_invalid_data(self, client, auth_headers):
        ...
        payload = {
            ...
            "checkpoint_data": {"status": "INVALID_STATUS"},
        }
    ...
    def test_register_checkpoint_unit_not_found(
        self, client, auth_headers, sample_checkpoint_data
    ):
    ...
    def test_get_tracking_history_success(
        ...
        create_response = client.post(
            "/api/v1/checkpoints", data=json.dumps(create_payload), headers=auth_headers
        )
        assert create_response.status_code == 201

        # Act - Obtener historial
        response = client.get(f"/api/v1/tracking/{tracking_id}", headers=auth_headers)
    ...
    def test_get_tracking_history_not_found(self, client, auth_headers):
        ...
        # Act
        response = client.get("/api/v1/tracking/NONEXISTENT456", headers=auth_headers)
    ...
    def test_get_tracking_history_invalid_tracking_id(self, client, auth_headers):
        ...
        # Act
        response = client.get("/api/v1/tracking/AB", headers=auth_headers)  # Muy corto
    ...
    def test_list_units_by_status_success(self, client, auth_headers):
        ...
        # Act
        response = client.get("/api/v1/shipments?status=CREATED", headers=auth_headers)
    ...
    def test_list_units_by_status_with_pagination(self, client, auth_headers):
        ...
        # Act
        response = client.get(
            "/api/v1/shipments?status=CREATED&limit=10&offset=0", headers=auth_headers
        )
    ...
    def test_list_units_by_status_invalid_status(self, client, auth_headers):
        ...
        # Act
        response = client.get(
            "/api/v1/shipments?status=INVALID_STATUS", headers=auth_headers
        )
    ...
    def test_method_not_allowed(self, client, auth_headers):
        ...
        # Act
        response = client.delete("/api/v1/checkpoints", headers=auth_headers)
