...
class UnitModel(db.Model):
    ...
    checkpoints = relationship("CheckpointModel", back_populates="unit", cascade="all, delete-orphan")
...
class ShipmentModel(db.Model):
    ...
    units = relationship("ShipmentUnitModel", back_populates="shipment", cascade="all, delete-orphan")
